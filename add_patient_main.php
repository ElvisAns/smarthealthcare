                            ...
                            <div class="content">
                                <form action="insertpatient.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Country of birth" name="country">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Device roll number</label>
                                                <input type="text" class="form-control" placeholder="the Device identifier" name="devId" >
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="The Device Location" name="location" >
                                            </div>
                                     ...
                                     <div class="row">
                                        <div class="col-md-6">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="The names of the tutor" name="tutor" >
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="The phone no of the tutor" name="tutorphone" >
                                            </div>
                                     ...
                                     <div class="row">
                                        <div class="col-md-6">
                                         ...
                                         <textarea rows="5" class="form-control" placeholder="Consultant observation" name="observation"></textarea>
                                     </div>
                                 </div>
                                    <div class="row">
                                        <div class="col-md-4">
