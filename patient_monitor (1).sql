...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2019 at 03:00 AM
...
--
-- Table structure for table `patient ids records`
--
...
--
-- Dumping data for table `patient ids records`
--
...
--
-- Table structure for table `real time patient state`
--
...
--
-- Dumping data for table `real time patient state`
--
...
--
-- Table structure for table `room_id`
--
...
--
-- Dumping data for table `room_id`
--
